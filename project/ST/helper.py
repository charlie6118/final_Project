...
def check(month, symbol):
    ...
    #webpage.add_header("User-Agent","Mozilla/5.0 (Macintosh; Intel Mac OS X 10_11_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/47.0.2526.106 Safari/537.36")
...
def get(month, symbol):
    ...
    stock.dic["5_days"] = round(day_point_5, 4)
    stock.dic["20_days"] = round(day_point_20, 4)
    stock.dic["60_days"] = round(day_point_60, 4)
